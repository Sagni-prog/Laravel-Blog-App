                ...
                <div class="post_body">
                  ...
                  @foreach ($article as $article)
                     <div class="test">
                         ...
                         <div class="post_text">
                             <p class="catagory">
                                 <span>Catagory: {{$article->catagory->catagory_name}}</span>
                                </p>
                                <div class="limit">
                              <p>
                                 {{Str::limit($article->body,50,'...')}}
                             </p>
                             <a href="{{url('single_article',["article" => $article])}}">Read More</a>
                            </div>
                             <div class="icons">
                                <span>
                                    <a href="{{url('single_article',["article" => $article])}}">
            ...
            <div class="fixed">
              <div class="post_catagories">
                ...
                <div class="catagory_body">
                    <a href="{{url('articles/catagory',["catagory_name" =>   $catagory->catagory_name])}}" class="catagory_links">
                        {{$catagory->catagory_name}}({{$catagory->articles->count()}})
                    </a>
                </div>
            @endforeach
            </div>
