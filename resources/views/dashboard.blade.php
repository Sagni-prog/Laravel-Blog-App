    ...
    <div class="container">
       <div class="fixed">
        ...
        <div class="main">
           ...
           <a href="article/add" class="btn_add_article">Add Article</a>
           <div class="form_area ">
                <div class="title">
                ...
                <div class="form_container activities">
                    <div class="right_selectors">
                        <button class="btn_select">Select All</button>
                        <button class="btn_select">Deselect All</button>
                    </div>
                    <div class="left_selectors">
                      
                        <button class="btn_select_delete">Delete Selected</button>
                        <div class="search">
          ...
          @foreach ($article as $article)
            <tbody>
                <tr>
                    <td class="flex"></td>
                <td>{{$article->title}}</td>
                 <td>{{$article->catagory->catagory_name}}</td>
                    <td>
                        <button class="btn_1">View</button>
                        <button class="btn_2">Edit</button>
                        <button class="btn_3">Delete</button>
                    </td>
                </tr> 
             </tbody>
          @endforeach
